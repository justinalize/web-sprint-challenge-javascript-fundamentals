...
//nestedFunction can acess the var internal because of closure which allows chil funcitons to get the scope of their paarent function
...
return names
 ...
 function lowerCaseNames(array){
  ...
  array.map(function(item){
    lowerNames.push(`${item.animal_name.toLowerCase()}`)
  })
return lowerNames
}
